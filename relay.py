...
if __name__ == "__main__":
    ...
    relay1 = Flasher(pin=17, on_time=1, off_time=1)  # Реле на GPIO 17
    relay2 = Flasher(pin=27, on_time=1, off_time=2)  # Реле на GPIO 27
    relay3 = Flasher(pin=22, on_time=1, off_time=3)  # Реле на GPIO 22
